...
function Home() {
  ...
  return (
    <>
      ...
      <div className="w-full min-h-screen bg-cover bg-center" style={{ backgroundImage: "url(" + BackgroundGlobalWarming + ")" }}>
        <div className="w-full min-h-screen p-[5%] flex flex-col justify-center items-center bg-black bg-opacity-30 backdrop-blur-[1px]">
